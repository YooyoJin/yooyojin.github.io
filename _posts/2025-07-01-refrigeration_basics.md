...
- 潜热：加入了热量，但是温度并未上升的热量。如水在100℃时，此时再加入更多的热量，即所谓的潜热，水将开始蒸发，但是水的温度不变维持在100℃；
    - 你把热量加进去，它没有用来升高温度，而是全部被液体抢走用来“拆散”液体分子、把它们变成气体了，这叫潜热。
    - 只要罐子里还有一滴液体，温度就不会变。只有当最后一滴液体也蒸发完了，你再继续加热，气体温度才会开始升高，这叫过热。
...
压缩机跳频点|跳频点是指空调压缩机不能运行的某些频率点，当空调压缩机运行在跳频点时，会出现功率增加，产生噪音等问题；对空调压缩机的跳频点进行识别，可以避免空调压缩机在跳频点运行，有助于减少不必要的能耗，提高空调整体能效比
露点温度|液体开始沸腾（产生第一个气泡）时的温度。
泡点温度|蒸汽开始冷凝（产生第一滴液滴）时的温度。对纯制冷剂来说，在同一个压力下，‘开始冒泡’和‘最后一滴干掉’的温度是一回事，就是一个数。咱们平常说的‘饱和温度’，就是它。。
